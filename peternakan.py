...
class Sapi(HewanTernak):
    def __init__(self, gender: str, tanggal_lahir: dt.date, berat_kg: float):
        ...
        self.info_potong = {"min": 18, "max": 24}  # Dalam bulan
...
class Ayam(HewanTernak):
    def __init__(self, gender: str, tanggal_lahir: dt.date, berat_kg: float):
        ...
        self.info_potong = {"min": 1.5, "max": 2}  # Minggu dikonversi ke bulan
...
class Unta(HewanTernak):
    def __init__(self, gender: str, tanggal_lahir: dt.date, berat_kg: float):
        ...
        self.info_potong = {"min": 48, "max": 60}  # Tahun dikonversi ke bulan
